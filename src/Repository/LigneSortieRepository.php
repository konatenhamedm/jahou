...
/**
 * @extends ServiceEntityRepository<LigneSortie>
 *
...
class LigneSortieRepository extends ServiceEntityRepository
{
    ...
    public function save(LigneSortie $entity, bool $flush = false): void
    {
    ...
    public function remove(LigneSortie $entity, bool $flush = false): void
    {
