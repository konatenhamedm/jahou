...
class VenteSubscriber implements EventSubscriberInterface
{
    ...
    public function handleValidation(TransitionEvent $event): void
    {
       ...
       // dd($entity);
        ...
        $lignes = $entity->getLigneSorties()->filter(function (LigneSortie $ligne) {
            return $ligne->getQuantite() != 0 ;
        })->toArray();

        $mouvement = new MouvementSortie();
    ...
    {
        return [
            'workflow.vente.transition.passer' => 'handleValidation',
